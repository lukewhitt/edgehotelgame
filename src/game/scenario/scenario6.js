const Scenario2 = {
  get (decisions) {
    ...
    return {
      ...
      popover: true,
      popoverText: 'Over time, more people book into your hotel, you accept and reject many different requests, and some people cancel on their bookings. Now you don’t have much room, and 3 requests come in at once.<br/><br/> Your job is to decide which offer(s) to take, and whether or not you would like to overbook. However, make sure you are careful when doing so, as now you can no longer restart until the end. You MUST select at least one offer.',
